...
remaws s3 cp ../temp/threads_1000000_0/ s3://magnet-fwm/home/LiveU/joint_scenario/Bodof_Group/ --recursive --exclude "*" --include "*.csv"
remaws s3 cp ../temp/threads_1000000_0/ s3://magnet-fwm/home/LiveU/joint_scenario/Bodof_Group/ --recursive --exclude "*" --include "*.txt"
